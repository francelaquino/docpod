...
@Component({
  selector: 'app-questionaire1',
  templateUrl: './questionaire1.component.html',
  styleUrls: ['./questionaire1.component.css']
})
export class Questionaire1Component implements OnInit {
